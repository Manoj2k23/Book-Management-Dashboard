  ...
  if (error) {
    return (
      <div className="text-center py-12">
        ...
        <button onClick={triggerRefresh} className="btn-primary">
          Retry
        </button>
      </div>
    )
    ...
    <div className="space-y-6" key={refreshKey}>
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-3">
          <button onClick={triggerRefresh} className="btn-secondary flex items-center gap-2">
          ...
          <button onClick={handleAddBook} className="btn-primary bg-[#293F79] flex items-center gap-2">
